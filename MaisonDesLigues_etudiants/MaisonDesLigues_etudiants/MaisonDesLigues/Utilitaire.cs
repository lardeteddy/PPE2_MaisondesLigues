...
namespace MaisonDesLigues
{
    internal abstract class Utilitaire
    {
        ...
        //Fonction permettant l'ajout de plusieurs textbox
        //public static void CreerTextBox(ScrollableControl UnContainer, String unNom, Int16 UnTop, Int16 UnLeft)
        //{
        //    TextBox UnTextBox = new TextBox();
        //    UnTextBox.Name = unNom;
        //    UnTextBox.Top = UnTop;
        //    UnTextBox.Left = UnLeft;
        //    UnTextBox.Visible = true;
        //    UnContainer.Controls.Add(UnTextBox);
        //}

        /// <summary>
        /// sucharge de la méthode RemplirComboBox permettant de remplir une combobox à partir d'une datatable
        /// </summary>
        /// <param name="UneConnexion">L'objet connexion à utiliser pour la connexion à la BD</param>
        /// <param name="MethodeDonneOracle">Variable nous renvoyant la table voulu</param>
        /// <param name="UneCombo"> La combobox que l'on doit remplir</param>
        /// <param name="DisplayMember">La valeur afficher</param>
        /// <param name="ValueMember"> La valeur réel</param>
        public static void RemplirComboBox(Bdd UneConnexion, DataTable MethodeDonneOracle, ComboBox UneCombo, String DisplayMember, String ValueMember)
        {
            UneCombo.DataSource = MethodeDonneOracle;
